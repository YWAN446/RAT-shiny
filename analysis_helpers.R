...
report_pathwayResult <- function(ps.freq, freq_thresh = 50) {
  ...
  for (i in 1:nrow(pathway_results)) {
    ...
    result_matrix[score[1], score[2]] <- paste0(result_matrix[score[1], score[2]], pathway_results[i, 'pathway'], sep=" \n")
  }
  ...
  return(list('dominant' = pathway_results[pathway_results$dominant == 1 & !is.na(pathway_results$dominant), 'pathway'], 'matrix' = result_matrix))
