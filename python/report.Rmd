...
# If running this independently, you will need to un-comment
# below and update all of these values. sorry. :(
# params:
#   city_name: Atlanta, GA
#   start_date: '2017-01-01'
#   end_date: !r Sys.Date()
#   lab_MF: no
#   lab_name: 'Some laboratory, LLC'
#   pathways: Drain Water, Ocean Water, and Private Latrines
#   language: "English"
#   household_data : !r data.frame()
#   school_data : !r data.frame()
#   community_data : !r data.frame()
#   sample_data : !r data.frame()
#   ps.freq : !r list() 
#   neighborhood_mapping : !r list()
#   pathway_codes : !r list()
#   pathway_labels : !r list()
#   freq_thresh: 50
---
```{r, echo=FALSE}
library(knitr)
...
# Executive Summary
```{r child="report_sections/Executive_Summary.Rmd"}
```

# Introduction
```{r child="report_sections/Introduction.Rmd"}
```

# Methodology
```{r child="report_sections/Methodology.Rmd"}
```

# Results and Discussion
```{r child="report_sections/Results_and_Discussion.Rmd"}
```

# Implications for Saniation Investment
```{r child="report_sections/Implications.Rmd"}
```

# Strengths and Limitations
```{r child="report_sections/Strengths_and_Limitations.Rmd"}
```

# Conclusion
```{r child="report_sections/Conclusion.Rmd"}
```
