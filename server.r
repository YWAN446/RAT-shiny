...
shinyServer(function(input, output, session) {
  ...
  # PLOTTING INFO ----------------------------------------------------------------
  # frequency counts for pie charts, histograms and people plots
  ...
  ps.frq1 <- reactive({
    calculate_householdFreq(household_data(), 'ppl plot')
  })
  ...
  ps.frq2 <- reactive({
    calculate_schoolFreq(school_data(), 'ppl plot')
  })
  ...
  ps.frq3 <- reactive({
    calculate_communityFreq(community_data(), 'ppl plot')
  })
  ...
  ps.frq0 <- reactive({
    calculate_combinedFreq(household_data(), school_data(), community_data(), 'ppl plot')
  })
